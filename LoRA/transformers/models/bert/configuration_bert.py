...
class BertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.lora_d_attn_dim = lora_d_attn_dim
        self.lora_d_attn_alpha = lora_d_attn_alpha
        self.lora_d_dropout = lora_d_dropout

        self.lora_inf = lora_inf
